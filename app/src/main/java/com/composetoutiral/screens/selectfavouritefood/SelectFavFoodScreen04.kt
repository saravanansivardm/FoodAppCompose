...
fun SelectFavFoodScreen04(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.ready_to_eat),
                color = Color.Black,
        ...
        Row(
            ...
            Button(
                onClick = {
                    ...
                    selectFavouriteFoodViewModel.navigateToHomePage(navController)
                },
                ...
                Text(
                    text = stringResource(id = R.string.find_food_near),
                    color = Color.Black,
...
@Composable
@Preview
fun PreviewSelectFavFoodScreen04() {
    SelectFavFoodScreen04(navController = rememberNavController())
}