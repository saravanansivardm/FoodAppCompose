...
fun SelectFavFoodScreen01(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(id = R.string.fav_food),
                color = Color.Black,
        ...
        LazyColumn(modifier = Modifier.padding(top = 32.dp)) {
            itemsIndexed(selectFavouriteFoodViewModel.getFavFood()) { index, item ->
                Card(
                    modifier = Modifier
                    ...
                    Row(
                        ...
                        Row(
                            ...
                            Box(
                                ...
                                Image(
                                    painter = painterResource(id = selectFavouriteFoodViewModel.getFavFood()[index].favFoodImage),
                            ...
                            Column {
                                Text(
                                    text = selectFavouriteFoodViewModel.getFavFood()[index].favFood,
                                ...
                                Text(
                                    text = selectFavouriteFoodViewModel.getFavFood()[index].favFoodDesc,
    ...
    Row(
        ...
        Button(
            onClick = {
                ...
                selectFavouriteFoodViewModel.navigateToFavFoodScreen02(navController)
            },
...
@Composable
@Preview
fun PreviewSelectFavFoodScreen01() {
    SelectFavFoodScreen01(navController = rememberNavController())
}